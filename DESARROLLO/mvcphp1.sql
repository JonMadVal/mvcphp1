...
INSERT INTO `posts` VALUES (2,'post2','Mensaje de prueba actualizado.'),(5,'Diseño','Es una una pagina chevere , esta de prueba .'),(6,'&quot;Niño&quot;','&lt;script&gt;alert(&#039;Hola Mundo&#039;);&lt;/script&gt;'),(7,'Usuario Administrador','Registro con datos de usuario autenticado.'),(8,'Mensaje ','Desde la pc de mi trabajo'),(9,'sugerencia','contenido de mensaje'),(10,'Guillermo','Es una prueba hecha a las 5:31 7-4-2014'),(11,'Guillermo','Prueba 5:32pm'),(12,'demo','Es un buen ejemplo '),(13,'Demo','Todo es posible con la Tecnologia....'),(14,'Guillermo','Una de las mejores películas es la IRON MAN 2  y El Sorprendente Hombre Araña'),(15,'Smarty','mensaje usando la plantilla de Smarty.');
