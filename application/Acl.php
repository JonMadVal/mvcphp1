...
class ACL
{
    ...
    public function __construct($id = false)
    {
        if($id){
            ...
            if(Session::get('id_usuario')){
                ...
                $this->_id = 0;// para cuando no este autenticado
            }
        }
    ...
    {
        // combina arrat de los permisos de rol con permisos de usuario
    ...
    {
        // devuelve una lista de los permisos para un rol especifico
        $ids = $this->_db->query(
